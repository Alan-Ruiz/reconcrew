...
location_1 = Location.create!(name: "Small kitchen", price: 55, description: "Brand new, haven't used it yet.", category: Category.find_by_name("kitchen"), user: User.last, address: "Plaza palmeras 6")
