...
hosue_extra1 = Locationextra.create(extra: natural_light, location: location_1)
house_extra2 = Locationextra.create(extra: wifi, location: location_1)
house_extra3 = Locationextra.create(extra: water, location: location_1)
house_extra4 = Locationextra.create(extra: toilete, location: location_1)
house_extra4 = Locationextra.create(extra: action, location: location_1)
house_extra4 = Locationextra.create(extra: soun_poof, location: location_1)
